<template>
  <div ref="container" class="waterfall-container" :style="containerStyle" @scroll.passive="handleScroll">
    ...
    <div class="waterfall-inner" :style="innerStyle">
      <section v-for="item in itemPositions" :key="item[props.getItemId(item)]" :style="getItemStyle(item)"
    ...
    <el-empty v-if="!isLoading && items.length === 0" description=" " style="margin-top: 20%" />
  </div>
</template>
