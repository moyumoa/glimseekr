<template>
  ...
  <virtual-waterfall ref="waterfallRef" :fetchPage="$api.folderPic.list"
    :defaultParams="{ folder_id: id }" :getItemId="item => item._id"
    ...
    <template #default="{ item, columnWidth, remove }">
      <a href="#" role="button" @click.prevent="navito(item)">
